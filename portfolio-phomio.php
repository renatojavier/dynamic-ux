									...
									<div class="entry bg-pink">
									    <div class="top-cont">
									        <div class="date">Posted Sun, Nov 29th
									            <a class="twitter" target="_blank" href="http://twitter.com/TomsTazLures/status/671452302457225217"></a>
									            <a class="facebook" target="_blank" href="http://facebook.com/photo.php?fbid=750240431746739"></a>
									        </div>
									        <img class="image" src="assets/img/matthew.jpg">
									    </div>
									    <p>Nice brownie</p>
									    <p class="sig"> - Matthew
									    ...
									    <a class="lure" target="_blank" href="#"><img src="assets/img/lure-055.png">
									    </a>
